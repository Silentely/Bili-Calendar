      ...
      <div class="anime-preview-content">
        <div class="anime-preview-header">
          ...
          <div class="anime-preview-actions">
            <button class="btn-filter" onclick="animePreview.showFilter()">
              <i class="fas fa-filter"></i> 筛选
            </button>
            <button class="btn-sort" onclick="animePreview.toggleSort()">
              <i class="fas fa-sort"></i> 排序
            </button>
            <button class="close-preview" onclick="animePreview.closePreview()">
        ...
        <div class="anime-preview-footer">
          ...
          <button class="btn-confirm" onclick="animePreview.confirmAndGenerate()">
